...
@media (prefers-color-scheme: dark) {
  ...
  @media (hover: hover) and (pointer: fine) {
    ...
    .dark\:hover\:bg-neutral-950\/10:hover {
    ...
    .dark\:hover\:shadow-neutral-400:hover {
...
font-display: swap;
font-weight: 100 900;
}.__className_ac79ff {font-family: '__GeistSans_ac79ff'
}.__variable_ac79ff {--font-geist-sans: '__GeistSans_ac79ff'
}
